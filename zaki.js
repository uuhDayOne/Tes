...
let fakeimage = fs.readFileSync("./media/allmenu.jpg")
...
_❒_ freefire text
 ...
 © 2022 | 𝚞𝚞𝚑𝙳??𝚢𝙾𝚗𝚎`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
if (isBanned)return sticBanned(from)
 qute = fs.readFileSync('./gambar/allmenu.jpg') 
